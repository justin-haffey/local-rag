...
- Build the indexing pipeline: iterative discovery; default VCS/build/dependency/secret-pattern ignores; no symlink traversal; 5 MiB file limit; encoding/line-ending normalization; generic line-preserving code/text chunks using the selected model tokenizer (384-token target, 480-token maximum, 64-token overlap); ONNX embedding with mean pooling and L2 normalization; bounded queues and retries.
